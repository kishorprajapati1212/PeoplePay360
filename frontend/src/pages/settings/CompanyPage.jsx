...
const SETTINGS = {
  ...
  'E-mail delivery': [
    ...
    { key: 'smtp_host', label: 'SMTP host (optional — Gmail needs none)', max: 160, placeholder: 'leave empty for Gmail',
      hint: 'Gmail/Google Workspace: leave this EMPTY — just the mail account + App Password below is enough. Only fill it for another provider (e.g. smtp.corp.in).' },
