import { z } from 'zod';
import { uuid, dateStr, optDate, money, email, trimmed, optText, pagination, statusEnum, boolish } from './common.js';
...
export const createBody = z.object({
  name: trimmed(120), work_email: email, phone: optText(30), gender: optText(20),
  ...
  esi_number: optText(30), notes: optText(1000), employee_code: optText(30),
