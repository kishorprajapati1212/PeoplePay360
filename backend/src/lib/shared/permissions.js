...
export const NAV_OVERRIDES = {
  ...
  payrun_admin: [
    { key: 'settings', label: 'Settings', to: '/company', perm: 'settings:read', children: [
      ...
      // "Salary Rules Help" pointed at /salary/rules, the same route the Payroll group lists as
      // "Rules" — one page lit two menu entries at once. The route is reached from Payroll alone.
    ] },
  ],
};
